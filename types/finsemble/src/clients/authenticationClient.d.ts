...
export declare class AuthenticationClient extends BaseClient {
     ...
     * @since TBD
     */
    getCurrentCredentials: (cb: StandardCallback<string | Error | CallbackError, any>) => void;
    /**
    ...
    appSignOn: (signOnKey: any, params: {
        ...
        force: boolean;
        userMsg?: string;
    }, cb: StandardCallback<string | Error | CallbackError, any>) => void;
    /**
     ...
     * @since TBD
     */
    completeOAUTH: (err?: string, params?: any, cb?: StandardCallback<string | Error | CallbackError, any>) => void;
    /**
