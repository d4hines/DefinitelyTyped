 ...
 * @constructor
 */
declare class ConfigClient extends BaseClient {
    listeners: any[];
    subs: any;
    ...
    */
    addListeners(params: listenerParam | listenerParam[] | fieldOnlyParam | string[], fn?: Function, cb?: Function): any;
    /**
     ...
     * (e.g. "finsemble.components"); however, if can also return all or part of the manifest which contains the Finsemble config property.
     ...
     * });
     */
    getPreferences(params?: any, callback?: StandardCallback): Promise<void>;
}
declare const configClient: ConfigClient;
