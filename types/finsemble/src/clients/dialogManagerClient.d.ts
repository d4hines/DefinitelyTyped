 ...
 * @hideconstructor
 */
declare class DialogManagerClient extends _BaseClient {
    /** Deprecated var.
     * @TODO - Remove this.
     */
     ...
     */
    sendQueryToDialog: (identifier: WindowIdentifier, options: any, onUserInput: any) => void;
    /**
     ...
     */
    moveDialogFromOpenedToAvailable: (identifier: WindowIdentifier) => void;
    /**
     * State management - just moves an available dialog out of the "available" pool.
     * @private
     * @param {object} identifier window identifier of the dialog.
     */
    moveDialogFromAvailableToOpened: (identifier: WindowIdentifier) => void;
    /**
