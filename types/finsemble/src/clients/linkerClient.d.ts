 ...
 * @constructor
 */
declare class LinkerClient extends _BaseClient {
    ...
    */
    unsubscribe(dataType: string, cb?: Function): void;
    /**
  ...
  * @param {array<string>} params.channels - Optional. Specifies which channels publish this piece of data. This overrides the default which is to publish to all linked channels.
    ...
    * });
    */
    subscribe(dataType: string, cb: Function): void;
    /**
    ...
    /**
     * Callback function for linkerStore.addListener({}).  Updates allChannels, allGroups, and clients.
     *
     * @param {object} response contains changed listener data
     * @private
     */
