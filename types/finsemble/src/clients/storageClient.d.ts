...
export declare class StorageClient extends _BaseClient {
     ...
     */
    save(params: componentMutateParams, cb?: StandardCallback): Promise<unknown>;
    /**
     *
     * @param params
     * @private
    ...
    remove(params: {
        key: string;
        topic: string;
    }, cb?: StandardCallback): Promise<unknown>;
    /**
     *
     * @param params
     * @private
    ...
    delete: (params: {
        key: string;
        topic: string;
    }, cb?: StandardCallback<string | Error | CallbackError, any>) => Promise<unknown>;
    /**
