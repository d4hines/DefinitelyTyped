...
import { Workspace, ActiveWorkspace } from "../common/workspace";
 ...
 */
declare class WorkspaceClient extends _BaseClient {
    /**
     ...
     * });
     */
    getWorkspaces(cb?: any): Promise<unknown>;
    /**
     * @private
     *
     * @param {*} params
     ...
     */
    setWorkspaceOrder(params: any, cb: any): Promise<unknown>;
    setWorkspaces: (params: any, cb: any) => Promise<unknown>;
    /**
     ...
     * });
     */
    save(cb?: Function): Promise<unknown>;
    /**
     ...
     * workspace will be marked dirty (or, if auto save is on, persisted directly to storage).
     */
     ...
     * });
     */
    isWorkspaceDirty(cb: any): Promise<unknown>;
    /**
     ...
     * @example <caption>FSBL.Clients.WorkspaceClient.export({'workspaceName:': 'linker'}, function(err, workspaceDefinition) {
     *
    ...
    /**
     * Saves one mor more template definitions in a selected file. Note the
