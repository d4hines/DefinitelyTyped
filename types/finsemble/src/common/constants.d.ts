...
export declare const SERVICE_QUERY_READY_CHANNEL: (name: any) => string;
export declare const CLIENT_SERVER_MAPPING: (name: any) => any;
...
export declare const WINDOW_SERVICE_REQUESTS: {
    REMOTE_FOCUS: string;
    SET_ALWAYS_ON_TOP: string;
    IS_ALWAYS_ON_TOP: string;
};
