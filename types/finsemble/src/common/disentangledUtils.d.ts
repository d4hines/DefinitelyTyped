 ...
 * the given message.
 */
export declare function timeoutPromise(ms: any, message: string): Promise<unknown>;
/**
...
/**
 * Given a config value, will attempt to pull a value from the config by searching newPath.newValue, then fall back to newPath.oldValue,
 * then fall back to oldPath.newValue, then fall back to oldPath.oldValue, then fall back to a provided default
 *
 * @param {object} data The json config to search
 * @param {object} params The parameters to perform the search
 * @param {string} params.baseString The base string of the path to search (this piece is unchanging)
 * @param {string} params.newPath The new path to search (e.g. "windowService")
 * @param {string} params.oldPath The old path to search (e.g. "dockingService")
 * @param {string || array} params.oldValue The old value (or paths if an array) to search for
 * @param {string} params.newValue The new value to search for
 * @param {string} default
 */
export declare function checkDeprecatedConfigs(data: any, params: any, defaultValue: any): any;
export {};
