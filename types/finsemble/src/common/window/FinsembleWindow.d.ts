...
export declare class FinsembleWindow {
    ...
    removeEventListener(eventName: WindowEventName, handler: any): Promise<unknown>;
    ...
    static _windowReady: (windowName: any) => Promise<unknown>;
    /**
     ...
     * @private
     */
    queryWindowService(methodName: any, params: any, callback?: Function): Promise<unknown>;
     ...
     */
    isAlwaysOnTop(params: any, callback: StandardCallback): void;
    isShowing(params: any, callback: any): void;
    setBounds(params: any, callback: any): void;
    getBounds(params: any, callback?: Function): Promise<unknown>;
     ...
     * @memberof FSBLWindow
     */
    initializeWindow({ manageWindowMovement, identifer }: {
        manageWindowMovement: any;
        identifer: any;
    }, cb?: Function): void;
    wrapReady(): void;
     ...
     * @private
     */
    _privateManagementPreface(methodName: any, params: any): any;
    /**
     ...
     * @memberof StackedWindow
     */
    addWindow(params: any, callback?: Function): Promise<unknown>;
    /**
     ...
     * @memberof StackedWindow
     */
    deleteWindow(params: any, callback?: Function): Promise<unknown>;
    /**
     ...
     * @memberof StackedWindow
     */
    setVisibleWindow(params: any, callback?: Function): Promise<unknown>;
    /**
     ...
     * @memberof StackedWindow
     */
    reorder(params: any, callback?: Function): Promise<unknown>;
}
