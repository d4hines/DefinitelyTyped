...
export declare type RegionTrackingParams = Record<string, any>;
...
export declare namespace Interface_Window {
    ...
    interface PublicWindowInterface {
        ...
        close(params: Record<string, any>): any;
        minimize(params: Record<string, any>): any;
        maximize(params: Record<string, any>): any;
        restore(params: Record<string, any>): any;
        focus(params: Record<string, any>): any;
        bringToFront(params: Record<string, any>): any;
        setBounds(params: Record<string, any>): any;
        getBounds(params: Record<string, any>): any;
        startMove(params: Record<string, any>): any;
        stopMove(params: Record<string, any>): any;
        hide(params: Record<string, any>): any;
        show(params: Record<string, any>): any;
        alwaysOnTop(params: Record<string, any>): any;
        setOpacity(params: Record<string, any>): any;
        getCurrentState(params: Record<string, any>): any;
        getOptions(params: Record<string, any>): any;
        addListener(params: Record<string, any>): any;
        removeListener(params: Record<string, any>): any;
    }
}
export {};
