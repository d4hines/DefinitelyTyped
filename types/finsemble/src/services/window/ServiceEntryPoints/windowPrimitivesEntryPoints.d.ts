...
export declare class WindowPrimitives {
    ...
    setAlwaysOnTopHandler(queryError: any, queryMessage: any): Promise<void>;
    isAlwaysOnTopHandler(queryError: any, queryMessage: any): Promise<void>;
    ...
    closeHandler(queryError: any, queryMessage: ResponderMessage): Promise<any>;
}
